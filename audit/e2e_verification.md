...
1. Export env vars:
   ...
   export INTAKE_BUCKET=demo-intake-bucket
   export SERVICE_URL=https://demo-ocr-summary-${REGION}-a.run.app
   ```
...
6. Confirm Pub/Sub DLQ topic empty: `gcloud pubsub subscriptions pull summary-pipeline-dlq-sub --limit=1` returns no messages.
